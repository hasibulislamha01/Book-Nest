                                ...
                                !user ?
                                    ...
                                    <div>
                                        ...
                                        <Link to='/updateProfile'>
                                            <button className="w-full text-xl font-semibold text-center hover:text-warning hover:bg-[#005C97] hover:bg-opacity-90 rounded-xl py-1">Update Profile</button>
                                        </Link>
                                    </div>
                            }
                        </div>
